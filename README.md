...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=2196F3&center=true&vCenter=true&width=435&lines=Full-Stack+Developer;AI+Enthusiast;Software+Engineering+Student;Problem+Solver" alt="Typing SVG" />
</p>
...
| :--- | :--- | :--- |
| **Portfy** | `Django`, `React` | A SaaS Portfolio builder that generates dynamic websites via simple forms. |
| **UDS (Ubuzima)** | `Node.js`, `WebSockets` | Real-time hospital queue management reducing wait-room confusion. |
| **Safeboda Clone** | `.NET Core`, `Blazor` | A two-sided ride-sharing marketplace with complex driver-matching logic. |
| **Umuturage Kwisonga** | `Civic-Tech` | Award-winning platform for citizen reporting and automated gov-routing. |
